...
- Los otros 8 workflows no generan todavía mediante modelo. `annual_plan`, `project`, `unit`, `activity` y `criterion_and_evidence` son los workflows habilitados mediante modelo. La interfaz, Supabase, despliegue, PDFs, embeddings, vector DB y Jev legacy siguen fuera de esta capa.
