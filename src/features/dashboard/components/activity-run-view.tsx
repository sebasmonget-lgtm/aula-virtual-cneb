...
export function ActivityRunView({ block, onBack, onEvidence, onStepChange, onComplete }: {
  ...
  return <section className="mx-auto max-w-3xl space-y-5">
    ...
    <div className="grid gap-3 sm:grid-cols-2"><Button variant="outline" className="h-12 border-[#87bdcb] text-[#126177]" onClick={onEvidence}><Camera /> Registrar evidencia</Button><Button className="h-12" onClick={onComplete}><CheckCircle2 /> Terminar actividad</Button></div>
